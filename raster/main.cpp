...
int main(){
    ...
    raster.drawLineBresenham(0,0, 1000, 800, 255, 255, 255);
    raster.drawLineBresenham(0,0, 100, 1000, 255, 255, 255);
    raster.drawLineBresenham(1500,100, 300, 400, 255, 255, 255);
    raster.drawLineBresenham(100,1000, 1500, 100, 255, 255, 255);
    raster.drawLineBresenham(500, 100, 500, 1000, 255, 255, 255);
    raster.drawLineBresenham(100, 500, 1000, 500, 255, 255, 255);
